...
<?php
  ...
  ?>
  <div class="container my-4 my-color">
  <div class="container w-100 justify-content-center d-flex d-inline-flex p-2 my-color">
    <h1 class="my-color">Fill the details properly</h1>
  </div>
  <div class="container cm  w-100 d-flex d-inline-flex p-2">
    <form action="user_login.php" method="post" class="row g-3 needs-validation my-color" novalidate>
      <div class="col-md-6 mt-3 my-color">
      ...
      <div class="col-md-6 mt-3 my-color">
        ...
        <input type="password" class="form-control my-color" id="validationCustom01" name="password" placeholder="Enter a password" required>
